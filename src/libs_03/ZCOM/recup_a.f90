!======================================================================
      Module recup_a
!======================================================================
!     contains working arrays for subroutines RECUP and ZRECUP
!----------------------------------------------------------------------
      Implicit none
...
!======================================================================
!     recoupling coefficients between schemes J2 and J3
...
!----------------------------------------------------------------------
      ...
      Do i=1,mj
       Jsign(i)=0        !  factors (-1)**[j1(i)*Jsing(i)]
       Jfact(i)=0        !  factors (2j1(i)+1)**(Jfact(i)/2)
      End do
!----------------------------------------------------------------------
