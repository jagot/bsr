...
!======================================================================
      Subroutine alloc_tmat_ion(m)
!======================================================================
!     allocate or deallocate the data in "tmat_ion"
!----------------------------------------------------------------------
      Use tmat_ion
...
!-----------------------------------------------------------------------
      ...
      if(mdata.eq.0) Call Alloc_tmat_ion(idata)
