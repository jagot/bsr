...
! ... loop over initial set:
      ...
      Do j1=1,mstate1
       Call Read_sol(j1,ctype1,inb1,kdm1,C1,Label1,E1,jot1)
...
!... loop over final set:
      ...
      Do j2=1,mstate2
       Call Read_sol(j2,ctype2,inb2,kdm2,C2,Label2,E2,jot2)

       if(istate2.gt.0.and.istate2.ne.j2) Cycle

       if(name1.eq.name2.and.j2.lt.j1) Cycle

! ... angular orthogonality:

      de = abs(E2 - E1); if(de.lt.2.d-8.and.kpol.ne.0) Cycle
