...
! ... read parameters from arguments if any
      ...
      Call Read_rarg('eps_ch'  ,eps_ch )
      Call Read_rarg('eps_cc'  ,eps_cc )

!      Call Read_aarg('eps_ovl' ,eps_ovl)
!      Call Read_aarg('eps_ndet',eps_ndet)

      write(*,'(/a,f10.5)') 'eps_ch = ',eps_ch
      write(*,'(/a,f10.5)') 'eps_cc = ',eps_cc
