!======================================================================
      Subroutine Read_sol(nn,ctype,nu,nc,C,Label,E,jot)
!======================================================================
...
!----------------------------------------------------------------------
      ...
      Integer, intent(in) :: nn,nu,nc
      Integer, intent(inout) :: jot

      Real(8), intent(out) :: E
      Real(8), intent(out) :: C(nc)

      Integer :: i, ns,nch,ncp,nhm,nstate
      ...
      Case('b')
       ...
       read(nu,*) ns,nch,ncp,nhm,nstate

       if(nhm.ne.nc) Stop 'Read_solution: incorect size of solurtion, ctype=b'
       if(nn.gt.nstate) Stop 'Read_solution: index > nstate, ctype=b'
