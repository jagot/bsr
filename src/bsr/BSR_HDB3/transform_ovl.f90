...
!----------------------------------------------------------------------
      ...
      if(io_processor) then
       ...
       rewind(nui)
       read(nui) i1,i2,ii
       Do ic=1,kch; read(nui) (S,i=1,ns*ns); End do

       ! ... skip other diagonal overlaps:
...
!---------------------------------------------------------------------------
      ...
      elseif(ic.gt.kch) then             !  ch-pert
       ...
       if(io_processor) then
        ...
        End do
        if(S.gt.eps_o) &
         write(pri,'(a,f10.3,a,i5,a,a,i5,5x,a,i5)') &
         'Warning: perturber-channel overlap =',S, &
         '  pertuber',ic-kch, &
         '  channel ',elc(jc),jc,'target',iptar(jc)
       end if
       ...
       if(io_processor) then
        ...
        End do; End do
        if(S.gt.eps_o) &
         write(pri,'(a,f10.3,2(5x,a,a,i5,a,i5))') &
