...
!======================================================================
!     processing of L-integrals in the module c_data
!----------------------------------------------------------------------
...
!                                                            L ( . . ):
      Case(1)
       ...
       Do j=1,ncdata;  i=IPT(j)
        ...
        i1=k1(i)/ibi; i2=mod(k1(i),ibi);  ic=-k3(i); jc=-k4(i)

        C = L_int(i1,i2)*cdata(i)
         ...
         if(iitar.gt.0.and.ich.ne.jch) &
          ...
          Call Stop_mpi(0,0,' L_data: unknown structure ')
...
!                                                            L ( . i ):
      Case(2,3,4,5)
       ...
       Do j=1,ncdata; i=IPT(j); C=cdata(i)
         ...
         Call L_vec(k2(i),v); ich=k3(i); io=k4(i)
         ...
         elseif(io.lt.0) then                           !  L(.i)  ic
          ...
          Call Stop_mpi(0,0,' L_data: uknown structure for itype 2-5 ')
         end if
...
!                                                            L ( i j ):
      ...
      Case Default
       ...
       Call Stop_mpi(0,0,' L_data: uknown itype ')
