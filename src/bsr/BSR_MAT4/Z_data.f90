...
!======================================================================
!     processing the Z-integrals from the module 'c_data'
!----------------------------------------------------------------------
       ...
       Do j=1,ncdata; i=IPT(j)
        ...
        ic=-k3(i); jc=-k4(i)
         ...
         elseif(ic.lt.0.and.jc.eq.0) then            ! Z(..) <i|j>                            !   < i | j >
          ...
          Call Stop_mpi(0,0,' Z_data: unknown structure ')
...
!                                                            Z ( . i ):
      Case(2,3,4,5)
       ...
       Do j=1,ncdata; i=IPT(j); C=cdata(i)
         ...
         Call Z_vec(k2(i),v); ich=k3(i); io=k4(i)
         ...
         elseif(io.lt.0) then                       !  Z(.i)  ic
          ...
          Call Stop_mpi(0,0,' Z_data: uknown structure for itype 2-5 ')
         end if
...
!                                                            Z ( i j ):
      ...
      Case Default
       ...
       Call Stop_mpi(0,0,' Z_data: uknown itype ')
