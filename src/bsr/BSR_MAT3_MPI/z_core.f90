...
!======================================================================
!
!     contain B-splne representation for Z-integral
...
!------------------------------------------------------------------
      ...
      Real(8), Allocatable :: Z_int(:,:), Z_vec(:,:)
...
! ... find max. l :
      ...
      mlz=0; Do i=1,nbf; if(lbs(i).gt.mlz) mlz=lbs(i); End do

      if(mlz.gt.mlso) mlz=mlso
