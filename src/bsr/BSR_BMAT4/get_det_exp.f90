!======================================================================
      Subroutine get_det_exp(is,js,ic,jc)
!======================================================================
      ...
      Integer :: status(MPI_STATUS_SIZE), is,js, ic,jc

      Call MPI_RECV(is,1,MPI_INTEGER, 0,0, MPI_COMM_WORLD, status, ierr)
      if(is.le.0) Return
      ...
      Call MPI_RECV(js  ,1,MPI_INTEGER,0,0,MPI_COMM_WORLD, status,ierr)
