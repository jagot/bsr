...
!----------------------------------------------------------------------
      ...
      Integer :: i, ii, it,jt, ik,jk, nuc, k, nsymc_bnk, nsymt_bnk
...
! ... check angular symmetry:
      ...
      write(*,'(a,a,a,3i10)') 'First set : ',trim(AF1),'  ncfg=',ncfg1, nsymc, nsymt
...
! ... check angular symmetry:
      ...
      write(*,'(a,a,a,3i10)') 'Second set: ',trim(AF2),'  ncfg=',ncfg2, nsymc, nsymt
...
! ... define if we need additional calculations
      ...
      if(icalc.eq.1) then
       write(*,*)
       write(*,'(a,a,a,i10)') 'First set : ',trim(AF1),'  ncfg=',ncfg1
       write(*,'(a,a,a,i10)') 'Second set: ',trim(AF2),'  ncfg=',ncfg2
       write(*,*)
       write(*,'(a,i5)') 'Number of conf. symmetries = ',NSYMC
