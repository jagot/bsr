!======================================================================
      Subroutine Read_conf(in1,in2,nub)
!======================================================================
...
! ... define symmetries in c-files:
      ...
      kset1 = 1
      Call Add_conf_LS(in1,kset1);  ncfg1=ncfg; nwf1=nwf
      kset2 = maxval(KEF(1:nwf)) + 1
      Call Add_conf_LS(in2,kset2);  ncfg2=ncfg-ncfg1; nwf2=nwf-nwf1

      if(nsymt.gt.nsymt_bnk.or.nsymc.gt.nsymc_bnk) &
       Stop 'mult_bnk is incomplete: nsymt > nsymt_bnk'
