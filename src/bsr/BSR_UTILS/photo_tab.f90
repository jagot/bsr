...
! ... choose the work:
    ...
    1 Continue
      ...
      write(*,*) '9  - dipole matrix elements, many'
      write(*,*) '0  - exit'
...
!       if(CL.gt.10*SS) then; IP_energy(ie)=1; else; SS = CL; end if
       ...
       write(nur,'(f16.8,f15.8,8E15.7)') ev(ie),e(ie), CL,CV  !,(CSR(ie,j),j=1,nphot)
...
!           '  E_phot(eV)', 'k^2', ('dr_L','di_L','dr_v','di_V',i=ich1,ich2)
      ...
      Do ie=1,ne
       write(nur,'(f12.8,f10.6, 200E16.8)') ev(ie), e(ie), &
            ((dd(i,j,ie),j=1,2),i=ich1,ich2)
      End do
