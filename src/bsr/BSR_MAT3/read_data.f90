...
! ... read substitute orbitals:
      ...
      write(pri,'(a,i6,a)')  'ncfg   = ',ncfg, &
        '  -  number of configurations'
      write(pri,'(a,i6,a/)')  'nwf    = ',nwf, &
        '  -  number of orbitals: '
      if(debug.gt.0) &
...
! ... read channel information and find pointer (orbital --> channel):
      ...
      if(jpar.lt.0) &
      write(pri,'(a,i6,a)')  'lpar   = ',lpar, '  -  total L '
      if(ispar.gt.0) &
      write(pri,'(a,i6,a)')  'ispar  = ',ispar,'  -  total 2S+1'
      write(pri,'(a,i6,a)')  'ipar   = ',ipar, '  -  parity'
      if(jpar.ge.0) &
      write(pri,'(a,i6,a)')  'jpar   = ',jpar-1, '  -  total 2J'

!----------------------------------------------------------------------
! ... readd B-spline expantions for bound orbitals:
