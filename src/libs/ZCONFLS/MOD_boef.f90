...
! ... debug paramters:
      ...
      Real(8) :: mem_boef = 0.d0, mem_max_boef = 0.d0
      Real(8) :: mem_blk = 0.d0, mem_max_blk = 0.d0
      Integer :: boef_realloc = 0, blk_realloc = 0
      Integer :: max_boef = 0, max_blk = 0
...
! ... add new integral:
      ...
      if(max_boef.lt.nboef) max_boef = nboef
